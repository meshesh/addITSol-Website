            ...
            <div className="container-pad">
                <div className="max-w-3xl mb-12 md:mb-16">
                    ...
                    <h2 className="font-heading text-3xl md:text-5xl font-semibold tracking-tight">
                        We partner with organizations to elevate delivery
                        performance.
                    </h2>
                    <p className="mt-5 text-base md:text-lg text-[#B8C2D1] leading-relaxed">
                        Improve delivery performance, establish scalable
                        governance frameworks, accelerate agile adoption, and
                        provide specialized project leadership resources.
                    </p>
                </div>
